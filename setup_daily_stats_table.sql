-- Simple Daily Stats Table Setup
-- This creates the basic table structure so the API will work
...
-- Create basic daily stats function
...
-- Initialize stats for all officers for today
INSERT INTO daily_queue_stats (
  officer_id,
  date,
  total_count,
...
-- Success message
SELECT 'Daily stats table created successfully!' as message; 